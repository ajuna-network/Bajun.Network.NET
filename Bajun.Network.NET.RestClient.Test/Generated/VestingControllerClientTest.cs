...
namespace Bajun.Network.NET.RestClient.Test.Generated
{
   ...
   public class VestingControllerClientTest : ClientTestBase
   {
      ...
      public Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 GetTestValue2()
      {
      ...
      public async System.Threading.Tasks.Task TestVestingSchedules()
      {
         ...
         Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 mockupValue = this.GetTestValue2();
         ...
         Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 rpcResult = await rpcClient.GetVestingSchedules(mockupKey);
