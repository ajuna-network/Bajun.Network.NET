...
namespace Bajun.Network.NET.RestClient.Test.Generated
{
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public Bajun.Network.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetTestValue3()
      {
         Bajun.Network.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result;
         result = new Bajun.Network.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal();
         result.Proposer = new Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Proposer = this.GetTestValue4();
         result.Value = this.GetTestValueU128();
         result.Beneficiary = new Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Bajun.Network.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal mockupValue = this.GetTestValue3();
         ...
         Bajun.Network.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT20 GetTestValue7()
      {
         Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT20 result;
         result = new Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT20();
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT20 mockupValue = this.GetTestValue7();
         ...
         Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT20 rpcResult = await rpcClient.GetApprovals();
