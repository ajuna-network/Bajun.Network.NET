...
namespace Bajun.Network.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockWeight"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Bajun.Network.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1)));
        ...
        public async Task<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> Account(Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo>(parameters, token);
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Bajun.Network.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1> BlockWeight(CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            return await _client.GetStorageAsync<Bajun.Network.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1>(parameters, token);
        }
        ...
        public async Task<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> Digest(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>(parameters, token);
        }
        ...
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> Events(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>(parameters, token);
        }
        ...
        public async Task<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>(parameters, token);
        }
        ...
        public async Task<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhase(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>(parameters, token);
        }
    }
    ...
    public sealed class SystemCalls
    {
        ...
        /// </summary>
        public static Method FillBlock(Bajun.Network.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill ratio)
        {
