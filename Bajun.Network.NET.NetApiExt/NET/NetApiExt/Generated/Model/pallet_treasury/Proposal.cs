...
namespace Bajun.Network.NET.NetApiExt.Generated.Model.pallet_treasury
{
    ...
    public sealed class Proposal : BaseType
    {
        ...
        /// >> proposer
        /// </summary>
        private Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 _proposer;
        ...
        /// >> beneficiary
        /// </summary>
        private Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 _beneficiary;
        ...
        public Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Proposer
        {
            get
            {
        ...
        public Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Beneficiary
        {
            get
            {
        ...
        {
            var start = p;
            Proposer = new Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Proposer.Decode(byteArray, ref p);
            Value = new Ajuna.NetApi.Model.Types.Primitive.U128();
            Value.Decode(byteArray, ref p);
            Beneficiary = new Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
