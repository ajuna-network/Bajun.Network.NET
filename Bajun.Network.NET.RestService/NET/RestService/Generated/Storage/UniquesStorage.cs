...
namespace Bajun.Network.NET.RestService.Generated.Storage
{
    ...
    public interface IUniquesStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionDetails GetClass(string key);
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemDetails GetAsset(string key);
        
        /// <summary>
        /// >> ClassMetadataOf
        ///  Metadata of a collection.
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionMetadata GetClassMetadataOf(string key);
        
        /// <summary>
        /// >> InstanceMetadataOf
        ///  Metadata of an item.
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemMetadata GetInstanceMetadataOf(string key);
        
        /// <summary>
        /// >> Attribute
        ///  Attributes of a collection.
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3, Ajuna.NetApi.Model.Types.Primitive.U128> GetAttribute(string key);
    ...
    public sealed class UniquesStorage : IUniquesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionDetails> _classTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemDetails> _assetTypedStorage;
        
        /// <summary>
        /// _classMetadataOfTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionMetadata> _classMetadataOfTypedStorage;
        
        /// <summary>
        /// _instanceMetadataOfTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemMetadata> _instanceMetadataOfTypedStorage;
        
        /// <summary>
        /// _attributeTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3, Ajuna.NetApi.Model.Types.Primitive.U128>> _attributeTypedStorage;
        ...
        {
            this.ClassTypedStorage = new TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionDetails>("Uniques.Class", storageDataProvider, storageChangeDelegates);
            ...
            this.AssetTypedStorage = new TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemDetails>("Uniques.Asset", storageDataProvider, storageChangeDelegates);
            this.ClassMetadataOfTypedStorage = new TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionMetadata>("Uniques.ClassMetadataOf", storageDataProvider, storageChangeDelegates);
            this.InstanceMetadataOfTypedStorage = new TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemMetadata>("Uniques.InstanceMetadataOf", storageDataProvider, storageChangeDelegates);
            this.AttributeTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3, Ajuna.NetApi.Model.Types.Primitive.U128>>("Uniques.Attribute", storageDataProvider, storageChangeDelegates);
            this.ItemPriceOfTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U128, Ajuna.NetApi.Model.Types.Base.BaseOpt<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>>("Uniques.ItemPriceOf", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionDetails> ClassTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemDetails> AssetTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionMetadata> ClassMetadataOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemMetadata> InstanceMetadataOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3, Ajuna.NetApi.Model.Types.Primitive.U128>> AttributeTypedStorage
        {
            get
            {
        ...
        ///  Details of a collection.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionDetails GetClass(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ClassTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionDetails result))
            {
                return result;
            }
            else
        ...
        ///  The items in existence and their ownership details.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemDetails GetAsset(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AssetTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemDetails result))
            {
                return result;
            }
            else
        ...
        ///  Metadata of a collection.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionMetadata GetClassMetadataOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ClassMetadataOfTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.CollectionMetadata result))
            {
                return result;
            }
            else
        ...
        ///  Metadata of an item.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemMetadata GetInstanceMetadataOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (InstanceMetadataOfTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.pallet_uniques.types.ItemMetadata result))
            {
                return result;
            }
            else
        ...
        ///  Attributes of a collection.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3, Ajuna.NetApi.Model.Types.Primitive.U128> GetAttribute(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AttributeTypedStorage.Dictionary.TryGetValue(key, out Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3, Ajuna.NetApi.Model.Types.Primitive.U128> result))
            {
                return result;
            }
            else
