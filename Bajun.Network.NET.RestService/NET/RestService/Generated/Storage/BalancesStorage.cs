...
namespace Bajun.Network.NET.RestService.Generated.Storage
{
    ...
    public interface IBalancesStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.pallet_balances.AccountData GetAccount(string key);
    ...
    public sealed class BalancesStorage : IBalancesStorage
    {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.pallet_balances.AccountData> AccountTypedStorage
        {
            get
            {
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.pallet_balances.AccountData GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.pallet_balances.AccountData result))
            {
                return result;
            }
            else
