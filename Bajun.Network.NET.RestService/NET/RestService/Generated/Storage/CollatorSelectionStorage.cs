...
namespace Bajun.Network.NET.RestService.Generated.Storage
{
    ...
    public interface ICollatorSelectionStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT17 GetInvulnerables();
        
        /// <summary>
        /// >> Candidates
        ///  The (community, limited) collation candidates.
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT18 GetCandidates();
    ...
    public sealed class CollatorSelectionStorage : ICollatorSelectionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT17> _invulnerablesTypedStorage;
        
        /// <summary>
        /// _candidatesTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT18> _candidatesTypedStorage;
        ...
        {
            this.InvulnerablesTypedStorage = new TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT17>("CollatorSelection.Invulnerables", storageDataProvider, storageChangeDelegates);
            this.CandidatesTypedStorage = new TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT18>("CollatorSelection.Candidates", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT17> InvulnerablesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT18> CandidatesTypedStorage
        {
            get
            {
        ...
        ///  The invulnerable, fixed collators.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT17 GetInvulnerables()
        {
        ...
        ///  The (community, limited) collation candidates.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT18 GetCandidates()
        {
