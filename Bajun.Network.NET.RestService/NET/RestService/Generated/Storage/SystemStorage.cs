...
namespace Bajun.Network.NET.RestService.Generated.Storage
{
    ...
    public interface ISystemStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo GetAccount(string key);
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256 GetBlockHash(string key);
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256 GetParentHash();
        
        /// <summary>
        /// >> Digest
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest GetDigest();
        ...
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord> GetEvents();
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo GetLastRuntimeUpgrade();
        ...
        /// </summary>
        Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase GetExecutionPhase();
    }
    ...
    public sealed class SystemStorage : ISystemStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> _accountTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256> _blockHashTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256> _parentHashTypedStorage;
        
        /// <summary>
        /// _digestTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> _digestTypedStorage;
        
        /// <summary>
        /// _eventsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> _eventsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> _lastRuntimeUpgradeTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> _executionPhaseTypedStorage;
        ...
        public SystemStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ParentHashTypedStorage = new TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256>("System.ParentHash", storageDataProvider, storageChangeDelegates);
            this.DigestTypedStorage = new TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>("System.Digest", storageDataProvider, storageChangeDelegates);
            this.EventsTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>("System.Events", storageDataProvider, storageChangeDelegates);
            ...
            this.LastRuntimeUpgradeTypedStorage = new TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>("System.LastRuntimeUpgrade", storageDataProvider, storageChangeDelegates);
            ...
            this.ExecutionPhaseTypedStorage = new TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>("System.ExecutionPhase", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _accountTypedStorage property
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> DigestTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> EventsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgradeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhaseTypedStorage
        {
            get
            {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.AccountInfo result))
            {
                return result;
            }
            else
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256 GetBlockHash(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BlockHashTypedStorage.Dictionary.TryGetValue(key, out Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
        ...
        ///  Hash of the previous block.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256 GetParentHash()
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest GetDigest()
        {
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EventRecord> GetEvents()
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo GetLastRuntimeUpgrade()
        {
        ...
        ///  The execution phase of the block.
        /// </summary>
        public Bajun.Network.NET.NetApiExt.Generated.Model.frame_system.EnumPhase GetExecutionPhase()
        {
