...
namespace Bajun.Network.NET.RestService.Generated.Controller
{
    ...
    public sealed class MultisigController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Multisigs")]
        [ProducesResponseType(typeof(Bajun.Network.NET.NetApiExt.Generated.Model.pallet_multisig.Multisig), 200)]
        [StorageKeyBuilder(typeof(Bajun.Network.NET.NetApiExt.Generated.Storage.MultisigStorage), "MultisigsParams", typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Bajun.Network.NET.NetApiExt.Generated.Types.Base.Arr32U8>))]
