...
namespace Bajun.Network.NET.RestService.Generated.Controller
{
    ...
    public sealed class TransactionPaymentController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Bajun.Network.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128), 200)]
        [StorageKeyBuilder(typeof(Bajun.Network.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage), "NextFeeMultiplierParams")]
        ...
        [ProducesResponseType(typeof(Bajun.Network.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases), 200)]
        [StorageKeyBuilder(typeof(Bajun.Network.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage), "StorageVersionParams")]
