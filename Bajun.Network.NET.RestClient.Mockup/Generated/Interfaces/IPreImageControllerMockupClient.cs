...
namespace Bajun.Network.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IPreimageControllerMockupClient
   {
      ...
      Task<bool> SetPreimageFor(BoundedVecT20 value, Ajuna.NetApi.Model.Types.Base.BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.primitive_types.H256, Ajuna.NetApi.Model.Types.Primitive.U32> key);
   }
}
