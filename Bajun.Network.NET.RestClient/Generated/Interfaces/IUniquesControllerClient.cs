...
namespace Bajun.Network.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IUniquesControllerClient
   {
      ...
      Task<BaseTuple> GetAccount(BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32, U32> key);
      Task<bool> SubscribeAccount(BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32, U32> key);
      Task<BaseTuple> GetClassAccount(BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      Task<bool> SubscribeClassAccount(BaseTuple<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      ...
      Task<BaseTuple<U128, BaseOpt<Bajun.Network.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>> GetItemPriceOf(BaseTuple<U32, U32> key);
